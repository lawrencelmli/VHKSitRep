...
ui <- dashboardPage(
  ...
  dashboardSidebar(
    ...
    sidebarMenu(
      ...
      menuItem("Instructions", tabName = "instructions", icon = icon("tools")),
      ...
      menuItem("CoViD-19", icon = icon("cog"), startExpanded = F,
               ...
               p("Date of COVID Report"),
               textOutput("COVID_date")
  ...
  dashboardBody(
    tabItems(
      tabItem(tabName = "instructions", h3("Instructions for Generating Report"),
      ...
      tabItem(tabName = "covid_night", h3("Night Capacity Report COVID-19"),
              ...
              fluidRow(
                box(title = "OVERALL SUMMARY", width = 12, collapsible = T,
                    ...
                    infoBoxOutput("nrc_admissions", width = 2),
                    infoBoxOutput("nrc_remain", width = 2),
                ...
                box(title = "FLOW", width = 12, collapsible = T,
                    box(title = "FLOW - SUMMARY", width = 12, collapsible = T, 
                      column(width = 6,
                        ...
                        infoBoxOutput("SEAL_flow", width = 2)
                        ),
                    fluidRow(
